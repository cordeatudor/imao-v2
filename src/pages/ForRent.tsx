...
const ForRent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO 
        title={t('propertyList.pageTitle.forRent')}
        description={t('propertyList.pageSubtitle.forRent')}
        keywords={[
          'închiriere locuințe Arad',
          'apartamente de închiriat Arad',
          'case de închiriat Arad',
          'spații comerciale Arad',
          'închirieri premium Arad',
      ...
      <section className="bg-purple-700 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('propertyList.pageTitle.forRent')}</h1>
            <p className="text-xl text-purple-100">
              {t('propertyList.pageSubtitle.forRent')}
            </p>
          </div>
        </div>
      </section>
